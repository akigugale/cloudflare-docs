...
Each Cloudflare account can reserve one handle.
...
Submit abuse reports, such as trademark infringement violations, to Cloudflare via [abuse.cloudflare.com](https://abuse.cloudflare.com/).
