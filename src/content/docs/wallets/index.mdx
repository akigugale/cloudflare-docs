...
Account Wallets are designed for humans who are owners and users of Cloudflare accounts. They will be able to add funds, delegate spend to virtual wallets managed by agents, and remove funds as needed. Account Wallets will also carry a [cloudflare.pay](https://cloudflare.pay/) stable identifier. 
