...
Handles are allocated first come, first served, and a reservation is permanent. Cloudflare does not change, release, or transfer a handle after it is reserved. For more information, refer to [Wallet handles](/cloudflare-wallets/wallet-handles/).
